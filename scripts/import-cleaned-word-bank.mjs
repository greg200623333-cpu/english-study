...
const sourceDir = 'E:/QMDownload/enlish data base/cleaned'
const batchSize = 500

const sources = [
  { file: 'CET4luan_1.cleaned.json', category: 'cet4', tier: 'core' },
  { file: 'CET4luan_2.cleaned.json', category: 'cet4', tier: 'full' },
  { file: 'CET6luan_1.cleaned.json', category: 'cet6', tier: 'core' },
  { file: 'CET6_2.cleaned.json', category: 'cet6', tier: 'full' },
  { file: 'KaoYanluan_1.cleaned.json', category: 'kaoyan', tier: 'core' },
  { file: 'KaoYan_2.cleaned.json', category: 'kaoyan', tier: 'full' },
]
